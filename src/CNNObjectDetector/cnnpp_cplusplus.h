...
namespace NeuralNetworksLib
{
	...
	namespace SIMD
	{
		...
		public:
			...
			void tanh_bn_2tanh(float* __restrict dst, float* __restrict src, int size_, float* __restrict conv_b, float* __restrict bn_w, float* __restrict bn_b, float* __restrict scale, float* __restrict snn_hl_w0, float* __restrict snn_hl_b0, float* __restrict snn_hl_w1, float* __restrict snn_hl_b1, float* __restrict snn_ol_w0, float* __restrict snn_ol_w1);
			...
			void mulC(float* dst, float* src_mulC, int size_, float* __restrict snn_ol_w);
			void mulC1_add(float* dst, float* src1_mulC, float* src2, int size_, float* __restrict snn_hl_w);
