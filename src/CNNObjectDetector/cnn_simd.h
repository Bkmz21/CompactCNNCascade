	...
	namespace SIMD
	{
		...
		private:
			...
			struct CNN
			{
				...
				std::vector<Array_32f> snn_hl_weight_fc;
			...
			void Run_single_thread(Image_32f& image);
			void Run_multi_threads(Image_32f& image);
		...
		public:
			...
			void Init(Legacy::ConvNeuralNetwork* _cnn, bool _max_pool = false, bool preprocessing = true);
#endif
