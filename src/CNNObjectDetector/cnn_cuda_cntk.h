	...
	namespace CUDA
	{
		...
		private:
			...
			struct CNN
			{
				...
				int hl_scale = 0;
				std::vector<SIMD::Array_32f> snn_hl_weight;
				...
				std::vector<SIMD::Array_32f> snn_ol_weight;
		...
		public:
			...
			void Forward(Image_32f_pinned* response_map, Image_32f* image, cudaStream_t cuda_stream = 0);
